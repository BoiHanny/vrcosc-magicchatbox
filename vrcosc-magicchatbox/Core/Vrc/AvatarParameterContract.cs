...
public static class AvatarParameterContract
{
    ...
    public static readonly IReadOnlyList<AvatarParameter> Parameters = new AvatarParameter[]
    {
        ...
        new("MCB/Cfg/Sending", AvatarParameterKind.Bool, AvatarParameterFlow.AvatarToApp, AvatarParameterTier.Config,
            "0 or 1", "IAppState.MasterSwitch", "EnableBridge, and a guard you have written",
        ...
        new("MCB/Cfg/HeartRate", AvatarParameterKind.Bool, AvatarParameterFlow.AvatarToApp, AvatarParameterTier.Config,
            "0 or 1", "IntegrationSettings.IntgrHeartRate", "EnableBridge, and a guard you have written",
        ...
        new("MCB/Cfg/Media", AvatarParameterKind.Bool, AvatarParameterFlow.AvatarToApp, AvatarParameterTier.Config,
            "0 or 1", "IntegrationSettings.IntgrScanMediaLink", "EnableBridge, and a guard you have written",
        ...
        new("MCB/Cfg/WindowActivity", AvatarParameterKind.Bool, AvatarParameterFlow.AvatarToApp, AvatarParameterTier.Config,
            "0 or 1", "IntegrationSettings.IntgrScanWindowActivity", "EnableBridge, and a guard you have written",
        ...
        new("MCB/Cfg/Status", AvatarParameterKind.Bool, AvatarParameterFlow.AvatarToApp, AvatarParameterTier.Config,
            "0 or 1", "IntegrationSettings.IntgrStatus", "EnableBridge, and a guard you have written",
